...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit: inject give the value into the first variable, and
    # the second variable take values from array
  ...
  #because we need to read every line separately instead all
